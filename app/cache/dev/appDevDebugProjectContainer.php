...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'admc_core_test' => 'getAdmcCoreTestService',
    ...
    /**
     * Gets the 'admc_core_test' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ADMC\CoreBundle\LdapServices\ADMCTest A ADMC\CoreBundle\LdapServices\ADMCTest instance.
     */
    protected function getAdmcCoreTestService()
    {
        return $this->services['admc_core_test'] = new \ADMC\CoreBundle\LdapServices\ADMCTest();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a8da810c7ef591e9fed1d818dd3e779a415cef35d66331b4ef78226aa84fbddf');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ADMC\\CoreBundle/Resources/views'), 'ADMCCore');
        $instance->addPath(($this->targetDirs[3].'\\src\\ADMC\\DSIBundle/Resources/views'), 'ADMCDSI');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0e2a8f5ef887db67eea62eb3d536403ad4df4ebc');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('575bd552df39e6.83903905')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ADMCCoreBundle' => 'ADMC\\CoreBundle\\ADMCCoreBundle',
                'ADMCDSIBundle' => 'ADMC\\DSIBundle\\ADMCDSIBundle',
            ...
            'secret' => '0e2a8f5ef887db67eea62eb3d536403ad4df4ebc',
            'locale' => 'en',
            ...
            'kernel.secret' => '0e2a8f5ef887db67eea62eb3d536403ad4df4ebc',
